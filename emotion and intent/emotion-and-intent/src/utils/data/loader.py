...
from src.utils.constants import INT_MAP as int_map
...
def load_dataset():
    ...
    for i in range(3):
        ...
        print("[intent]:", data_tra["intent"][i])
...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        item["intent_text"] = self.data["intent"][index]
        ...
        item["intent"], item["intent_label"] = self.preprocess_emo(item["intent_text"], self.int_map)
...
def collate_fn(data):
    ...
    d["target_program_intent"] = item_info["intent"]
    d["program_label_intent"] = item_info["intent_label"]
    ...
    d["program_txt_intent"] = item_info["intent_text"]
